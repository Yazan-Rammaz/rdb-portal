...
const MobileTransactionStepRender = ({ showTransactions, dri, transaction, ...rest }: StepRenderProps) => {
    ...
    const truncateAddress = (address: string, startLength = 8, endLength = 8) => {
    ...
    return (
        <div className="relative group">
            ...
            <div
                {...rest}
                className=" pl-[20px] rounded-t-[10px] relative bg-[#F7F7F7] z-[999] grid grid-rows-2 items-center w-full h-[80px]"
            >
                <div className='grid grid-cols-[8%_36%_36%_20%]'>
...
export default MobileTransactionStepRender;
