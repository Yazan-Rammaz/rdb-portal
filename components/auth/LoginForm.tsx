...
const LoginForm: React.FC<LoginFormProps> = ({ user, onChangePassword }) => {
  ...
  const [step, setStep] = useState<'username' | 'pin'>(user?.id ? 'pin' : 'username');
    ...
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full max-w-[450px]">
      ...
      <div className="w-full transition-all duration-500 ease-in-out">
        {step === 'username' ? (
          ...
          <form onSubmit={handleUsernameSubmit} className="flex flex-col items-center w-full px-4">
                ...
                >
                   <div 
                    ...
                    style={{ 
                      ...
                      maskRepeat: 'no-repeat',
                      maskPosition: 'center',
                      WebkitMaskImage: 'url(/assets/icons/auth/enterUser.svg)',
                      WebkitMaskRepeat: 'no-repeat',
                      WebkitMaskPosition: 'center'
                    }} 
                   />
          ...
          <div className="flex flex-col items-center w-full gap-6 animate-fadeIn">
            <div className="flex flex-col items-center gap-3">
              <div className="relative w-[120px] h-[120px] overflow-hidden rounded-[30px] shadow-md border-4 border-white">
                <Image 
                  src={userData?.avatar || "/img/user.png"} 
            ...
            <div className={`transition-all duration-300 ${notValidPin ? 'animate-shake' : ''}`}>
              <PinInputs 
                value={pinValue}
